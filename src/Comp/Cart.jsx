    ...
    return (
        ...
        ${activeCart ? "translate-x-0" : "translate-x-full"
            ...
            >
                ...
                p-1 text-xl rounded-md hover:text-red-400 hover:border-red-400 cursor-pointer'/>
                </div>
                ...
                <div className=' absolute bottom-0'>
                    ...
                    <h3 className='font-semibold text-gray-700'>Total Amount: {totalPrice}</h3>
                    <hr className=' w-[90vw] lg:w-[18vw] my-2' />
                    <button 
                     onClick={()=> navigate("/success")}
                     className='bg-green-700 font-bold px-3 text-white py-2 rounded-lg w-[90vw] lg:w-[18vw] mb-5'
                    >Checkout</button>
                </div>
            </div>
            <FaShoppingCart
